...
add wave -noupdate -format Analog-Step -height 40 -max 1936.0000000000002 -min -1952.0 -radix decimal /TestQamCarRec/qam_if_fil
add wave -noupdate -format Analog-Step -height 40 -max 7627839.9999999981 -min -7067008.0 -radix decimal /TestQamCarRec/theCarrRecov/mix
add wave -noupdate -format Analog-Step -height 40 -max 4219420.0 -min -3636560.0 -radix decimal -radixshowbase 0 /TestQamCarRec/theCarrRecov/mix_fil
...
add wave -noupdate -format Analog-Step -height 40 -max 2046.9999999999998 -min -1956.0 -radix decimal /TestQamCarRec/loc_cos
add wave -noupdate -format Analog-Step -height 40 -max 1946.9999999999998 -min -1947.0 -radix decimal /TestQamCarRec/lcsin_ref
add wave -noupdate -format Analog-Step -height 40 -max 1946.9999999999995 -min -2047.0 -radix decimal /TestQamCarRec/loc_sin
add wave -noupdate -format Analog-Step -height 40 -max 2043.9999999999995 -min -2048.0 -radix decimal /TestQamCarRec/theCarrRecov/mix_fil_dly
add wave -noupdate -format Analog-Step -height 40 -max 2042.9999999999998 -min -2046.0 -radix decimal /TestQamCarRec/theCarrRecov/ph_diff
add wave -noupdate -format Analog-Step -height 40 -max 2045.9999999999998 -radix decimal /TestQamCarRec/theCarrRecov/phd_abs
add wave -noupdate -format Analog-Step -height 40 -max 2046.0 -min -2048.0 -radix decimal /TestQamCarRec/theCarrRecov/phd_peak
add wave -noupdate -format Analog-Step -height 40 -max 255.00000000000003 -min -256.0 -radix decimal /TestQamCarRec/theCarrRecov/phd_th
...
WaveRestoreCursors {{Cursor 1} {8331234 ps} 0}
...
update
WaveRestoreZoom {0 ps} {20576826 ps}
