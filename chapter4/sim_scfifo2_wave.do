...
add wave -noupdate -divider {In ScFifo}
add wave -noupdate /TestScFifo/theFifo/write
add wave -noupdate -radix hexadecimal -radixshowbase 0 /TestScFifo/theFifo/din
add wave -noupdate /TestScFifo/theFifo/read
...
add wave -noupdate -radix hexadecimal -radixshowbase 0 /TestScFifo/theFifo/dout
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {81100 ps} 0}
...
update
WaveRestoreZoom {0 ps} {496700 ps}
