...
add wave -noupdate -radix unsigned -childformat {{{/TestR22Sdf/cnt[1]} -radix unsigned} {{/TestR22Sdf/cnt[0]} -radix unsigned}} -radixshowbase 0 -subitemconfig {{/TestR22Sdf/cnt[1]} {-height 15 -radix unsigned} {/TestR22Sdf/cnt[0]} {-height 15 -radix unsigned}} /TestR22Sdf/cnt
...
WaveRestoreCursors {{Cursor 1} {135127 ps} 0}
