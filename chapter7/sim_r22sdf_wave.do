...
add wave -noupdate -radix decimal -childformat {{{/TestR22Sdf/theR22Sdf/bf2i_x1[2].re} -radix decimal} {{/TestR22Sdf/theR22Sdf/bf2i_x1[2].im} -radix decimal}} -radixshowbase 0 -subitemconfig {{/TestR22Sdf/theR22Sdf/bf2i_x1[2].re} {-height 15 -radix decimal -radixshowbase 0} {/TestR22Sdf/theR22Sdf/bf2i_x1[2].im} {-height 15 -radix decimal -radixshowbase 0}} {/TestR22Sdf/theR22Sdf/bf2i_x1[2]}
add wave -noupdate -radix decimal -radixshowbase 0 {/TestR22Sdf/theR22Sdf/bf2i_z1[2]}
add wave -noupdate -radix decimal -radixshowbase 0 {/TestR22Sdf/theR22Sdf/bf2i_x0[2]}
add wave -noupdate -radix decimal -childformat {{{/TestR22Sdf/theR22Sdf/bf2i_z0[2].re} -radix decimal} {{/TestR22Sdf/theR22Sdf/bf2i_z0[2].im} -radix decimal}} -radixshowbase 0 -subitemconfig {{/TestR22Sdf/theR22Sdf/bf2i_z0[2].re} {-height 15 -radix decimal -radixshowbase 0} {/TestR22Sdf/theR22Sdf/bf2i_z0[2].im} {-height 15 -radix decimal -radixshowbase 0}} {/TestR22Sdf/theR22Sdf/bf2i_z0[2]}
add wave -noupdate -radix decimal -radixshowbase 0 {/TestR22Sdf/theR22Sdf/bf2ii_x1[2]}
add wave -noupdate -radix decimal -radixshowbase 0 {/TestR22Sdf/theR22Sdf/bf2ii_z1[2]}
add wave -noupdate -radix decimal -radixshowbase 0 {/TestR22Sdf/theR22Sdf/bf2ii_x0[2]}
add wave -noupdate -radix decimal -radixshowbase 0 {/TestR22Sdf/theR22Sdf/bf2ii_z0[2]}
add wave -noupdate -radix decimal -radixshowbase 0 {/TestR22Sdf/theR22Sdf/w[1]}
...
add wave -noupdate -radix decimal -radixshowbase 0 {/TestR22Sdf/theR22Sdf/bf2ii_z0[1]}
add wave -noupdate /TestR22Sdf/theR22Sdf/ccnt
add wave -noupdate -radix unsigned -radixshowbase 0 {/TestR22Sdf/theR22Sdf/waddr[0]}
add wave -noupdate -radix decimal -childformat {{{/TestR22Sdf/theR22Sdf/w[0].re} -radix decimal} {{/TestR22Sdf/theR22Sdf/w[0].im} -radix decimal}} -radixshowbase 0 -subitemconfig {{/TestR22Sdf/theR22Sdf/w[0].re} {-height 15 -radix decimal -radixshowbase 0} {/TestR22Sdf/theR22Sdf/w[0].im} {-height 15 -radix decimal -radixshowbase 0}} {/TestR22Sdf/theR22Sdf/w[0]}
...
update
WaveRestoreZoom {82011 ps} {82439 ps}
